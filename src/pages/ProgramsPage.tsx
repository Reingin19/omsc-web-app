...
interface Program {
  ...
  title: string;
  description: string;
  location: string; // Ito ang 'campus' sa DB mo
  date: string;
  participants?: number; // Optional kung wala pa sa DB
  status: string;
}
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center h-64 space-y-4">
            ...
            <p className="text-xs font-black uppercase italic text-slate-400 tracking-widest">Loading Programs...</p>
          </div>
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="flex items-start justify-between">
                    <Badge className={`rounded-lg px-3 py-1 font-black italic uppercase text-[9px] tracking-wider border-none ${
                  ...
                  <div className="space-y-3 pt-4 border-t border-slate-50">
                    <div className="flex items-center space-x-3 text-[11px] font-black uppercase italic text-slate-400">
          ...
          <div className="text-center py-20 bg-white rounded-[3rem] shadow-inner">
            <p className="text-slate-400 font-black italic uppercase tracking-[0.2em]">No programs found matching your search.</p>
          </div>
        )}
      </div>
    </div>
